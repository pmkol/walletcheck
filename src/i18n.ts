...
export const translate = createTranslator({
  ...
  '文字识别模型解压后的大小不正确。': ['The decompressed OCR model has an invalid size. ', '文字辨識模型解壓後的大小不正確。'],
  '文字识别模型无法解压，文件可能损坏。': ['The OCR model cannot be decompressed and may be corrupted. ', '文字辨識模型無法解壓，檔案可能損壞。'],
  '文字识别模型语言不正确。': ['The OCR model language is invalid. ', '文字辨識模型語言不正確。'],
  '文字识别模型响应不是二进制数据，可能返回了网页或被拦截。': ['The OCR model response is not binary data. A web page may have been returned or the request blocked. ', '文字辨識模型回應不是二進制資料，可能回傳了網頁或被攔截。'],
  '文字识别模型文件不完整或已损坏。': ['The OCR model file is incomplete or corrupted. ', '文字辨識模型檔案不完整或已損壞。'],
